...
layout: essay
type: essay
title: "Effort Estimation vs. Actual Effort"
...
In terms of actually tracking the time it took, I started off with a timer during M1 and partially M2. In all honesty, there were plenty of times where I forgot to start the timer, so I opted to just go based off of the start time, and the time I pushed the branch/code to origin. I believe it was somewhat accurate +/- 5 minutes.

## Future Considerations

Next time around I would definitely account for my underestimations during this project.

As for AI use, I didn't and don't think I'd use AI to track my effort or estimate how long a task would take. The former because tracking time is a menial task, and the latter because the AI doesn't know the extent of my abilities (very little).
